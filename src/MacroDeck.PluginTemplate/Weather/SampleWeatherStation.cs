...
namespace MacroDeck.PluginTemplate.Weather;
...
/// </summary>
internal sealed class SampleWeatherStation(TemplateIntegration integration) : IWeatherStation
{
	...
	/// <see cref="TemplateIntegration.InitializeAsync"/> to seed a first reading. A real provider would
